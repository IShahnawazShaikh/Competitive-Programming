...
public class P1598D {
	...
	static MyFastReaderP1598D in = new MyFastReaderP1598D();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
            ...
            for(int i=0;i<n;i++)  cnt+=1l*(mpA.get(a[i])-1)*(mpB.get(b[i])-1);	
...
class MyFastReaderP1598D {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1598D() {
