...
public class P1618B {
	...
	static MyFastReaderP1618B in = new MyFastReaderP1618B();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
            ...
            for(int i=0;i<n-2;i++) arr[i]=sc.next();
            
            StringBuilder sb=new StringBuilder();
           
            for(int i=1;i<n-2;i++) {
            	
            	if(arr[i-1].charAt(1)==arr[i].charAt(0)) sb.append(arr[i-1].charAt(0)); 	
...
class MyFastReaderP1618B {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1618B() {
