...
public class P1631A {
	...
	static MyFastReaderP1631A in = new MyFastReaderP1631A();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
			...
			int mx2 = 0;
			for (int i = 0; i < n; i++) {
				mx2 = Math.max(b[i], mx2);
			}
			out.print(1l * mx1 * mx2);
			out.print("\n");
			out.flush();
		}
		out.close();
...
class MyFastReaderP1631A {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1631A() {
