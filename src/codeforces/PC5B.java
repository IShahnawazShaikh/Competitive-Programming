...
public class PC5B {
	...
	static MyFastReaderPC5B in = new MyFastReaderPC5B();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
            ...
            else if(a==b && c%2==0) out.print("YES");
            
            else if(b==c && a%2==0) out.print("YES");
            
            else if(a==c && b%2==0) out.print("YES");
            else out.print("NO");
...
class MyFastReaderPC5B {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderPC5B() {
