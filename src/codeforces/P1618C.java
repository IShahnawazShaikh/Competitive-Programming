...
public class P1618C {
	...
	static MyFastReaderP1618C in = new MyFastReaderP1618C();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
            ...
            for(int i=1;i<n;i+=2) gcd1=GCD(arr[i],gcd1);
            for(int i=0;i<n;i+=2) gcd2=GCD(arr[i],gcd2);
            boolean st=true;
            
            for(int i=0;i<n;i+=2) {
            	if(arr[i]%gcd1==0) st=false;
            }
            if(st) out.print(gcd1);
            else {
            	st=true;
            	 for(int i=1;i<n;i+=2) {
                 	if(arr[i]%gcd2==0) st=false;
                 }
            	 
            	 if(st) out.print(gcd2);
            	 else out.print(0);
            }
...
class MyFastReaderP1618C {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1618C() {
