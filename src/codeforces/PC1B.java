...
public class PC1B {
	...
	static MyFastReaderPC1B in = new MyFastReaderPC1B();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
			...
			for(int i=0;i<n;i++) mp.put(1l*ar[i], mp.getOrDefault(1l*ar[i],0)+1);
...
class MyFastReaderPC1B {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderPC1B() {
