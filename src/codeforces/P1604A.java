...
public class P1604A {
	...
	static MyFastReaderP1604A in = new MyFastReaderP1604A();
		...
		while (test-- > 0) {
			...
			for(int i=1;i<=n;i++) {
				...
				if(arr[i-1]>i+count) {
				   ...
				   long cnt=Math.abs(arr[i-1]-(i+count));
				   count+=cnt;
				   
				   //System.out.println(cnt+" "+count+" "+i);
...
class MyFastReaderP1604A {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1604A() {
