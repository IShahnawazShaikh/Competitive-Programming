...
public class P1582C {
	...
	static MyFastReaderP1582C in = new MyFastReaderP1582C();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
			...
			int n = i();
			String s = string();
			long ans = Integer.MAX_VALUE, cnt = 0;
			for (int i = 0; i < 26; i++) {

				cnt = getCount(s, (char) (i + 'a'));
	...
	private static long getCount(String s, char ch) {
		int cnt = 0;
...
class MyFastReaderP1582C {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1582C() {
