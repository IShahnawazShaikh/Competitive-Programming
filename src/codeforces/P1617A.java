...
public class P1617A {
	...
	static MyFastReaderP1617A in = new MyFastReaderP1617A();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
            ...
            for(int i=0;i<sortedS.length();i++) count[sortedS.charAt(i)-'a']++;
            
            //System.out.println(sortedS);
            StringBuilder sb=new StringBuilder();
            
            if(count[t.charAt(0)-'a']==0 || count[t.charAt(1)-'a']==0 || count[t.charAt(2)-'a']==0) {
            	out.println(sortedS);
            	continue;
            }
            ...
            for(int i=0;i<26;i++) {
            		...
            		if((t.charAt(1)-'a')!=i) {
                     //System.out.println(t.charAt(1)+" "+(char)(i+'a')); 
...
class MyFastReaderP1617A {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1617A() {
