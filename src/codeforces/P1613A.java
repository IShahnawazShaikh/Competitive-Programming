...
public class P1613A {
	...
	static MyFastReaderP1613A in = new MyFastReaderP1613A();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
			...
			if (String.valueOf(x).length() + a < String.valueOf(y).length() + b) {
				out.print("<");
				
			} else if (String.valueOf(x).length() + a > String.valueOf(y).length() + b) {
				out.print(">");
	...
	public static void ans(long x, long y) {
		if (x < y) {
			out.print("<");
...
class MyFastReaderP1613A {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1613A() {
