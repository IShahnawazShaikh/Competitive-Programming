...
public class P1618A {
	...
	static MyFastReaderP1618A in = new MyFastReaderP1618A();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
            ...
            int p1=1,p2=6;
            while(p1<p2) {
            	if(arr[p1]+arr[p2]==arr[6]-arr[0]) {
            		break;
            	}
            	else if (arr[p1]+arr[p2]>arr[6]-arr[0]) p2-=1;
            	else p1+=1;
            }
            out.print(arr[0]+" "+arr[p1]+" "+arr[p2]);;
			out.print("\n");
			out.flush();
		}
		out.close();
...
class MyFastReaderP1618A {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1618A() {
