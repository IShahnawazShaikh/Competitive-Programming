...
public class P1616B {
	...
	static MyFastReaderP1616B in = new MyFastReaderP1616B();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
		    ...
		    else if(s.charAt(0)==s.charAt(1)) out.print(s.charAt(0)+""+s.charAt(0));
		    else {
...
class MyFastReaderP1616B {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderP1616B() {
