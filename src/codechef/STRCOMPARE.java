...
public class STRCOMPARE {
	...
	static MyFastReaderSTRCOMPARE in = new MyFastReaderSTRCOMPARE();
	...
	public static void main(String[] args) throws Exception {
		...
		while (test-- > 0) {
            ...
            for(int i=0;i<n;i++) {
              if(s.charAt(i)<t.charAt(i)) status[i]=true;
            }
            for(int i=n-2;i>=0;i--) {
            ...
            for(int i=0;i<n;i++) if(status[i]) ans+=1;
...
class MyFastReaderSTRCOMPARE {
	BufferedReader br;
	StringTokenizer st;

	public MyFastReaderSTRCOMPARE() {
